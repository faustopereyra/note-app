...
const OptionButton = (props) => (
  <div className={`plus btn-position ${props.optionActive ? "plus--active" : ""}`} onClick={props.toggleOption} >
    <div className="plus__line plus__line--v">
      ...
      <a href="#" className="plus__link" onClick={props.toggleAddNote} ><FaStickyNote /></a>
